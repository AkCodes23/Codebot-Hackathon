#changes made for optimization: removed the top‐level imports of speech_recognition, pyttsx3, and groq
#A new cached helper, get_groq_client_resource(). A small edit to initialize_groq_client() so it uses this cached helper instead of calling Groq(...) directly.
...
# --- Cached STT Recognizer Factory ---
@st.cache_resource
def get_stt_recognizer():
    """
    Return a single speech_recognition.Recognizer instance per session.
    """
