...
// Make sure that './_generated/api' exports 'messages' as part of 'api'
...
http.route({
  ...
  handler: httpAction(async (ctx, request) => {
    ...
    await ctx.runMutation(api.message.sendMessage, { content: content!, file: storageId, user: user!, group_id: group_id as Id<'groups'> });
