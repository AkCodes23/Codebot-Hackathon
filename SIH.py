...
GROQ_API_KEY = "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"  # Replace this with your actual key
TAVILY_API_KEY = "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"
...
def initialize_groq_client():
    if 'groq_client' not in st.session_state or st.session_state.groq_client is None:
        ...
        if not GROQ_API_KEY or GROQ_API_KEY == "YOUR_GROQ_API_KEY_HERE": 
            ...
            st.error("⚠️ **Groq API Key Required**: Please get your API key from https://console.groq.com/ and replace 'YOUR_GROQ_API_KEY_HERE' in main.py line 47")
